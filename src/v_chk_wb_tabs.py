...
class DefAr51(NewTab):
    def __init__(self, wb_obj):
      ...
      # self.tab_common = wb_obj.tab_common
        ...
        self.tab_def['tab_cd_fixed_grid']   = {  # [col,row,font,sz, w,t_clr,fill_clr,Bold,Ital,  Align,  val ] = 11
            # totals headers (across and down)
            'Wb-Options':   [1, 20, '', 14, 51,   '', sea2, True, False, 'left', 'Workbook Options']
            , 'Wb-Opt-Val': [0,  0, '', 12, 20,   '', sea2, True, False, 'center', 'Currently']
            , 'Opt-Links':  [1, 21, '', sz,  0,   '', '', False, False, 'left',
                            'Use Full Vault Pathnames for Note Links']
            , 'opt-link-val': [0, 0, '', sz, 0,   '', '', False, False, 'center', 'TRUE']
            ...
            , 'f-tot-03':     [1, 41, '', 12, 0,   '', '', False, False, 'left', 'Dups Tested']
            , 'x-tot-03':     [0,  0, '', 12, 0,   '', '', False, False, 'right', ctot[3]]
            , 'f-tot-04':     [1, 42, '', 12, 0,   '', '', False, False, 'left', 'Known Nested Tags Files Found']
            , 'x-tot-04':     [0,  0, '', 12, 0,   '', '', False, False, 'right', ctot[4]]
            , 'f-tot-05':     [1, 43, '', 12, 0,   '', '', False, False, 'left', 'Frontmatter YAML Files']
            , 'x-tot-05':     [0,  0, '', 12, 0,   '', '', False, False, 'right', ctot[5]]
            , 'f-tot-06':     [1, 44, '', 12, 0,   '', '', False, False, 'left', 'Inline YAML Files']
            , 'x-tot-06':     [0,  0, '', 12, 0,   '', '', False, False, 'right', ctot[6]]
            , 'f-tot-07':     [1, 45, '', 12, 0,   '', '', False, False, 'left', 'upd_obs_files']
            , 'x-tot-07':     [0,  0, '', 12, 0,   '', '', False, False, 'right', ctot[7]]
            , 'f-tot-08':     [1, 46, '', 12, 0,   '', '', False, False, 'left', 'upd_obs_nests']
            , 'x-tot-08':     [0,  0, '', 12, 0,   '', '', False, False, 'right', ctot[8]]
            , 'f-tot-09':     [1, 47, '', 12, 0,   '', '', False, False, 'left', 'upd_obs_props']
            , 'x-tot-09':     [0,  0, '', 12, 0,   '', '', False, False, 'right', ctot[9]]
