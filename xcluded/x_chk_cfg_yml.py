...
class Config:
    ...
    def write_config(self, cfg_obj):
        ...
        try:
            with open(self.v_chk_pn_cfg, 'w') as yaml_file:
                # yaml.dump(range(50), width=50, indent=4)
                yaml.dump({
                    'c_date':       self.c_date,
                    'bat_num':      self.bat_num,
                    'dbug':         self.dbug,
                    'v_chk_pn_cfg': self.v_chk_pn_cfg,
                    'v_chk_pn_wbs': self.v_chk_pn_wbs,
    ...
    def read_config(self, cfg):
        ...
        try:
            with open(self.v_chk_pn_cfg, 'r') as file_y:
            ...
            self.v_chk_pn_cfg = config_data.get('v_chk_pn_cfg', {})
            self.v_chk_pn_wbs = config_data.get('v_chk_pn_wbs', {})
            self.dir_vault     = config_data.get('dir_vault', {})
            ...
            self.pn_wb_exec = config_data.get('pn_wb_exec', {})
